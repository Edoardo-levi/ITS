""""Scrivere un programma in Python che utilizzi un match statement per classificare un voto scolastico 
...
voto=int(input("inserisci un voto (1-10):\n"))
