...
denominatore = 1
i = 1
while abs(pigrego - 3.14) > 0.01:
    if i % 2 == 1:
        pigrego += 4 / denominatore
    else:
        pigrego -= 4 / denominatore
    denominatore += 2
    i += 1
print("Termini per π ≈ 3.14:", i)

pigrego = 0
denominatore = 1
i = 1
while abs(pigrego - 3.141) > 0.001:
    if i % 2 == 1:
        pigrego += 4 / denominatore
    else:
        pigrego -= 4 / denominatore
    denominatore += 2
    i += 1
print("Termini per π ≈ 3.141:", i)

pigrego = 0
denominatore = 1
i = 1
while abs(pigrego - 3.1415) > 0.0001:
    if i % 2 == 1:
        pigrego += 4 / denominatore
    else:
        pigrego -= 4 / denominatore
    denominatore += 2
    i += 1
print("Termini per π ≈ 3.1415:", i)

pigrego = 0
denominatore = 1
i = 1
while abs(pigrego - 3.14159) > 0.00001:
    if i % 2 == 1:
        pigrego += 4 / denominatore
    else:
        pigrego -= 4 / denominatore
    denominatore += 2
    i += 1
print("Termini per π ≈ 3.14159:", i)



# esercizio spiegato dal prof
