...
model.add(tf.keras.layers.Dense(32, activation=tf.keras.activations.relu, input_shape=(2,)))
...
model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=0.1), loss=tf.keras.losses.MeanSquaredError(), metrics=[tf.keras.metrics.Accuracy()])
