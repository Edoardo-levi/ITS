...
select id, nome, cognome 
  from Persona 
    where posizione = 'Professore Oridinario' and posizione = 'Professore Associato'
    and cognome like 'V%';
...
select distinct giorno 
  from AttivitaNonProgettuale 
    where tipo = 'Didattica' order by giorno;